...
class FullyAsyncRollouter(FullyAsyncRayPPOTrainer):
    ...
    async def _feed_samples(self):
        print("[FullyAsyncRollouter][Feed] Start feeding samples")
    ...
    async def _processor_worker(self):
        ...
        try:
            ...
            print(
                "[FullyAsyncRollouter][Processor] Exception encountered "
    ...
    async def _streaming_generation_main(self):
        ...
        try:
            ...
            print(
                "[FullyAsyncRollouter] Tasks finished early. "
                f"done={[t.get_name() for t in done]}, pending={[t.get_name() for t in pending]}"
            )
            ...
            print(
                "[FullyAsyncRollouter] Streaming process exception "
                f"{e.__class__.__name__}: {e}\n{traceback.format_exc()}"
            )
