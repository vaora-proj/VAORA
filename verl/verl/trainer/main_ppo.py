...
class TaskRunner:
    ...
    def run(self, config):
        ...
        reward_fn = load_reward_manager(
            config, tokenizer, num_examine=0, task_type=config.data.get('task_type'), **config.reward_model.get("reward_kwargs", {}), 
        )
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=1, task_type=config.data.get('task_type'), **config.reward_model.get("reward_kwargs", {}),
        )
        ...
        trainer = RayPPOTrainer(
            ...
            task_type=config.data.get('task_type')
        )
