...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        self.item_counter = 0
        print(f"Training Steps: {config.get('training_steps', 300)}")
        self.training_steps = config.get("training_steps", 300)
    ...
    def __getitem__(self, item):
        ...
        row_dict["extra_info"]["item_counter"] = self.item_counter // self.training_steps
        self.item_counter += 1
        return row_dict
