"""
Batch inference agent using OpenAI ChatGPT vision API.

Usage:
    OPENAI_API_KEY=<key> python chatgpt_agent.py \
        --env_type phyre \
        --model_name gpt-4o \
        --dataset_path ../build_dataset/qwen3_dataset_my_cross_fold_1.json \
        --log_dir_base /tmp/chatgpt_logs/phyre \
        --log_dir_label tmp_log/chatgpt/
"""
...
from agent.chatgpt import ChatGPTVLClient  # noqa: E402
from agent import base_agent  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch ChatGPT explorer for PHYRE and MiniGrid."
    )
    ...
    parser.add_argument(
        "--log_dir_base",
        type=str,
        default="/home/u5597173/repo/Batch_Inference/batch_inference_output/chatgpt/phyre",
    )
    parser.add_argument("--log_dir_label", type=str, default="tmp_log/chatgpt/phyre/")
