...
class Body(object):
    ...
    def __init__(self, position=None, bodyType=None, angle=0, shapes=None, color=None, shapeType=0, diameter=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.shapeType = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.DOUBLE:
                    self.diameter = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.shapeType is not None:
            oprot.writeFieldBegin('shapeType', TType.I32, 6)
            oprot.writeI32(self.shapeType)
            oprot.writeFieldEnd()
        if self.diameter is not None:
            oprot.writeFieldBegin('diameter', TType.DOUBLE, 7)
            oprot.writeDouble(self.diameter)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
Body.thrift_spec = (
    ...
    (3, TType.DOUBLE, 'angle', None, 0, ),  # 3
    (4, TType.LIST, 'shapes', (TType.STRUCT, [Shape, None], False), None, ),  # 4
    (5, TType.I32, 'color', None, None, ),  # 5
    (6, TType.I32, 'shapeType', None, 0, ),  # 6
    (7, TType.DOUBLE, 'diameter', None, None, ),  # 7
)
